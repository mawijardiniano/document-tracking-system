...
const Incoming = () => {
  ...
  const [editDoc, setEditDoc] = useState(null); // Track document being edited
  ...
  // Edit Document - Save Changes
  const saveEdit = async (id) => {
    try {
      await axios.put(`http://localhost:5000/api/document/update-document/${id}`, editDoc);
                    ...
                    <>
                      <td className="px-4 py-1 border text-sm">
                        <input
                          ...
                          onChange={(e) => setEditDoc({ ...editDoc, agency: e.target.value })}
                      ...
                      <td className="px-4 py-1 border text-sm">
                        <input
                          ...
                          onChange={(e) => setEditDoc({ ...editDoc, purposeOfLetter: e.target.value })}
                          className="border p-1"
                        />
                      </td>
                      <td className="px-4 py-1 border text-sm">
